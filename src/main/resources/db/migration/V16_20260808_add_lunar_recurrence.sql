...
ALTER TABLE `events`
    ADD COLUMN `lunar_day`   INT DEFAULT NULL COMMENT 'Ngay Am lich (1-30), chi dung khi recurrence_type=LUNAR_YEARLY' AFTER `recurrence_type`,
    ADD COLUMN `lunar_month` INT DEFAULT NULL COMMENT 'Thang Am lich (1-12), chi dung khi recurrence_type=LUNAR_YEARLY' AFTER `lunar_day`;
